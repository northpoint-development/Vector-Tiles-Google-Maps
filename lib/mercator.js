...
/**
 * Converts a `Point` object to a `LatLng` numeric object.
 * @param {Point} point
 * @return {LatLng}
 */
...
/**
 * Returns a `Tile` object given a `LatLng` Google Maps object and a specified `zoom`.
 * @param {google.maps.LatLng} latLng
 * @param {Number} zoom
 * @return {Tile}
 */
...
/**
 * Returns a `TileBounds` object containing the Northeast and Southwest edges of a `Tile`.
 * @param {Tile} tile
 * @return {TileBounds}
 */
...
/**
 * Normalizes the `x` and `y` of a `Tile` object.
 * @param {Tile} tile
 * @return {Tile}
 */
...
/**
 * Converts a `LatLng` numeric object, provided through `evt`, to a `TilePoint`.
 * @param {google.maps.Map} map
 * @param {Evt} evt
 * @return {Point}
 */
